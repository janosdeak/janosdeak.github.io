    ...
    handler: () => {
      ...
      handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/news/announcement-LK-szeptember/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/janosdeak", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/márk-jánosdeák-069703296", "_blank");
        },
      },{
      id: 'light-theme',
